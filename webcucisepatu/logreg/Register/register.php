    ...
    <div class="row">
      <div class="col-md-7 offset-md-2">
        <div class="login-form">
          <form action="cek_registrasi.php" method="register">
              <div>
              ...
              <div class="form-group">
                  <input class="form-control" placeholder="Phone Number" name="nomer" type="text" required="required">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  <center> <input type="submit" class="btn btn-block btn-primary" name="register" value="Register"> </center>
              </div>
