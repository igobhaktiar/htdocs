        ...
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="icon/1day.png" alt="#"/>
              <div class="overlay_hover"> <a class="add-bt" href="product_detail1.html">Detail</a> </div>
            </div>
          </div>
        ...
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="icon/speedometer.png" alt="#"/>
              <div class="overlay_hover"> <a class="add-bt" href="product_detail2.html">Detail</a> </div>
            </div>
          </div>
          <div class="product_detail text_align_center">
        ...
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="icon/running.png" alt="#"/>
              <div class="overlay_hover"> <a class="add-bt" href="product_detail3.html">Detail</a> </div>
            </div>
          </div>
          <div class="product_detail text_align_center">
        ...
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="icon/shoe.png" alt="#"/>
              <div class="overlay_hover"> <a class="add-bt" href="product_detail4.html">Detail</a> </div>
            </div>
          </div>
          <div class="product_detail text_align_center">
        ...
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="icon/cap.png" alt="#"/>
              <div class="overlay_hover"> <a class="add-bt" href="product_detail5.html">Detail</a> </div>
            </div>
          </div>
          <div class="product_detail text_align_center">
            <p class="product_price">15K
        ...
        <div class="full product">
          <div class="product_img">
            <div class="center"> <img src="icon/bag.png" alt="#"/>
              <div class="overlay_hover"> <a class="add-bt" href="product_detail6.html">Detail </a> </div>
            </div>
          </div>
          <div class="product_detail text_align_center">
