              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="alert alert-danger">
                      <strong>Danger !</strong> Anda gagal login, email tidak ditemukan. mohon cek email anda
                  </div>
                  ...
                  ?>
                  <div class="alert alert-danger">
                      <strong>Danger !</strong> Anda gagal login, password salah. Mohon cek password anda
                  </div>
                  <?php
                    }
                  }
