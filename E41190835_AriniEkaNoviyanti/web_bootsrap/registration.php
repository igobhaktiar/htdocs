            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <label>Jenis Kelamin :</label>
                    <input type="radio" id="jenis_kelamin" name="jenis_kelamin" value="laki" required="">Laki-Laki 
                ...
                <textarea class="form-control" rows="5" id="biografi" name="biografi"></textarea>
                </div>
                ...
                <?php
                  ...
                  if($biografi){
                    echo "<strong>Biografi Anda:</strong> {$biografi} <br>";
                  }
                ?>  
                    </form>
                </div>
